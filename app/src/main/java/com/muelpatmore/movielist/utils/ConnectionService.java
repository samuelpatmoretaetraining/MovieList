package com.muelpatmore.movielist.utils;
        ...
        import static com.muelpatmore.movielist.utils.Constants.BASE_URL;
...
//    }
    ...
    public static RequestInterface BackendService() {
        ...
        File httpCacheDirectory = new File(MovieListApp.getApplication().getCacheDir(),  "responses");
    ...
    public static boolean isOnline() {
        ConnectivityManager cm = (ConnectivityManager) MovieListApp.getApplication().getSystemService(Context.CONNECTIVITY_SERVICE);
